"""
Django settings for REST_API_DIPLOM project.
...
ALLOWED_HOSTS = os.getenv('POSTGRES_HOST').split()
...
ROOT_URLCONF = 'REST_API_DIPLOM.urls'
...
WSGI_APPLICATION = 'REST_API_DIPLOM.wsgi.application'
